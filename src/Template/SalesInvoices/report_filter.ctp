				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<?php echo $this->Form->control('Stock_group_id',['empty'=>'-Select Stock Groups-', 'class'=>'form-control input-sm party_ledger_id select2me','label'=>false, 'options' => $StockGroups]);
							?>
						</div>
					</div>
					<div class="col-md-6" align="center">
