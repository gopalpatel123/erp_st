						...
						<table id="main_table" class="table table-condensed table-bordered" style="margin-bottom: 4px;">
							<thead>
								<tr>
									...
									<td><label>No of Cartoon<label></td>
								</tr>
							</thead>
...
<table id="sample_table" style="display:none;" >
	<tbody>
		<tr class="main_tr" class="tab">
			...
			<td width="" >
				<?php echo $this->Form->input('no_of_cartoon', ['label' => false,'class' => 'form-control input-sm rightAligntextClass','placeholder'=>'Cartoon','required']); ?>
			</td>
