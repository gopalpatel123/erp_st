	...
	<div class="col-md-12">
		...
		<?php if($status!='excel'){ ?>
			<div class="portlet-title">
				...
				<div class="actions">
					<?php echo $this->Html->link( '<i class="fa fa-file-excel-o"></i> Excel', '/PurchaseInvoices/hsnWiseReport/'.@$url_excel.'&status=excel',['class' =>'btn btn-sm green tooltips pull-right','target'=>'_blank','escape'=>false,'data-original-title'=>'Download as excel']); ?>
				</div>
			</div>
			<?php } ?>
