								...
								?>
									<tr class="MainTr" row_no="<?php echo $i;?>">
										<td width="10%">
											...
											if($i==0)
											{
												echo $this->Form->input('journal_voucher_rows.'.$i.'.cr_dr', ['options'=>['Cr'=>'Cr'],'label' => false,'class' => 'form-control input-sm cr_dr','required'=>'required','readonly'=>'readonly']); 
											}
											else if($i==1)
											{
												echo $this->Form->input('journal_voucher_rows.'.$i.'.cr_dr', ['options'=>['Dr'=>'Dr'],'label' => false,'class' => 'form-control input-sm cr_dr','required'=>'required','value'=>'Dr','readonly'=>'readonly']);
											}
											else{
											...
											?>
												...
												?>
													<tr>
														...
														?>
															...
															{
																echo $this->Form->input('journal_voucher_rows.'.$i.'.reference_details.'.$j.'.ref_name', ['options'=>$refDropDown[$journal_voucher_row->id],'label' => false,'class' => 'form-control input-sm paymentType refList','required'=>'required','value'=>$reference_detail->ref_name]);
												...
												<tfoot>
												    <tr class="remove_ref_foot">
														...
														<td><input type="text" class="form-control input-sm rightAligntextClass total calculation ttl noBorder"  value="<?php echo $journal_voucher_row->total;?>" name="journal_voucher_rows[<?php echo $i;?>][total]" readonly></td>
										...
										<?php if(empty($journal_voucher_row->debit))
											...
											?>
											<?php echo $this->Form->input('debit', ['label' => false,'class' => 'form-control input-sm  debitBox numberOnly rightAligntextClass totalCalculation','placeholder'=>'Debit','value'=>$journal_voucher_row->debit,'style'=>@$style1]); ?>
										...
										?>
											<?php echo $this->Form->input('credit', ['label' => false,'class' => 'form-control input-sm  creditBox numberOnly rightAligntextClass totalCalculation','placeholder'=>'Credit','value'=>$journal_voucher_row->credit,'style'=>@$style2]); ?>
										</td>
...
<table id="sampleForRef" style="display:none;" width="100%">
	<tbody>
		<tr>
			...
			<td width="" style="padding-left:0px; vertical-align: top !important;">
