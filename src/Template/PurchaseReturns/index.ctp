		...
		<div class="portlet light ">
				...
				<div class="actions">
					<form method="GET" id="">
						<div class="row">
							...
							<div class='col-sm-3'>
								<?php echo $this->Form->input('Prvoucher_no',['class'=>'form-control input-sm pull-right','label'=>false, 'placeholder'=>' Purchase Invoice Voucher.No','value'=>@$voucher_no]);
								?>
							</div>
							<div class='col-md-2'>
								<div class="form-group">
			...
			<div class="portlet-body">
				<div class="table-responsive">
					<?php $page_no=$this->Paginator->current('PurchaseReturns'); $page_no=($page_no-1)*100; ?>
