		...
		<div class="portlet light ">
			<div class="portlet-title">
				...
				<!-- <div class="actions"> 
					...
					?>
						<?php echo $this->Html->link('Open',['controller'=>'Challans','action' => 'index/'],['escape'=>false,'class'=>$class1,'style'=>'padding: 1px 5px;']); ?>&nbsp;
						<?php echo $this->Html->link('Cancel',['controller'=>'Challans','action' => 'index/Cancel'],['escape'=>false,'class'=>$class2,'style'=>'padding: 1px 5px;']); ?>&nbsp;
					<?php  ?>
			...
			<div class="portlet-body">
				<div class="table-responsive">
					<?php $page_no=$this->Paginator->current('Challans');
					...
					<table class="table table-bordered table-hover table-condensed">
						...
						<tbody>
							<?php foreach ($challans as $salesInvoice): ?>
							<tr>
								<td><?= h(++$page_no) ?></td>
								<td>
								...
								<td class="actions">
									...
									<?= $this->Html->link(__('View'), ['action' => 'challan_bill', $salesInvoice->id],['escape'=>false,'target'=>'_blank']) ?>&nbsp;&nbsp;
									<?php if (in_array("91", $userPages)){
									 ?>
									<?= $this->Html->link(__('Proceed To Invoice'), ['action' => 'ConvertedIntoInvoice', $salesInvoice->id],['confirm' => __('Are you sure you want to converted into invoice# {0}?',h(str_pad($salesInvoice->voucher_no, 3, '0', STR_PAD_LEFT)))]) ?><?php }  ?>
								</td>
							</tr>
							<?php endforeach; ?>
						</tbody>
