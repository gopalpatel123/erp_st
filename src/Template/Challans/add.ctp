		...
		<div class="portlet light ">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green-sharp bold ">Challan</span>
				</div>
				<div class="actions">
...
<?php
	...
	function rename_rows()
	{
		...
		$('#main_table tbody#main_tbody tr.main_tr').each(function(){
			...
			$(this).find('td:nth-child(1) select.attrGet').select2().attr({name:'challan_rows['+i+'][item_id]',id:'challan_rows['+i+'][item_id]'});
			
			$(this).find('.quantity').attr({name:'challan_rows['+i+'][quantity]',id:'challan_rows['+i+'][quantity]'});
			$(this).find('.rate').attr({name:'challan_rows['+i+'][rate]',id:'challan_rows['+i+'][rate]'});
			$(this).find('.discount').attr({name:'challan_rows['+i+'][discount_percentage]',id:'challan_rows['+i+'][discount_percentage]'});

			$(this).find('.dis_amount').attr({name:'challan_rows['+i+'][discount]',id:'challan_rows['+i+'][discount]'});
			$(this).find('.gstAmount').attr({name:'challan_rows['+i+'][taxable_value]',id:'challan_rows['+i+'][taxable_value]'});

			$(this).find('.gst_figure_id').attr({name:'challan_rows['+i+'][gst_figure_id]',id:'challan_rows['+i+'][gst_figure_id]'});

			$(this).find('.discountAmount').attr({name:'challan_rows['+i+'][net_amount]',id:'challan_rows['+i+'][net_amount]'});
			$(this).find('.is_gstvalue_excluded').attr({name:'challan_rows['+i+'][is_gst_excluded]',id:'challan_rows['+i+'][is_gst_excluded]'});
			$(this).find('.gstValue').attr({name:'challan_rows['+i+'][gst_value]',id:'challan_rows['+i+'][gst_value]'});
